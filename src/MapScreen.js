...
export function MapScreen(props) {
    ...
    return (
        <Layout>
            <Header style={{position: 'fixed', zIndex: 1, width: '100%', height:'14%', backgroundColor:'#1E90FF', display: 'inline'} }  >
                {/*<div className="logo"/>*/}
            ...
            <Content className="site-layout" style={{padding: '0 50px',paddingTop:50, marginTop: 64}}>
                ...
                <div className="site-layout-background"
                    ...
                    >
                        ...
                        {objects===null?undefined:objects.map((g)=><Marker position={{lat: g.latitude, lng: g.longitude}} name={g.name} onClick={onMarkerClick}/>)}
                    ...
                    <div style={{paddingLeft:15, paddingTop:550}}>
                        <Button type="primary" onClick={onLogOutHandle}>Log Out</Button>
